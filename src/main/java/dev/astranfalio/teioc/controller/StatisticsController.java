...
public class StatisticsController {
    ...
    public ResponseEntity<?> getOverallPerformance() {
        ...
        return ResponseEntity.ok(averageScore); // fixme: remove response entity
    }
    ...
    public ResponseEntity<?> getSurveyPerformanceForAllInterns() {
        ...
        return ResponseEntity.ok(allPerformances); // fixme: remove response entity
    }
    ...
    public ResponseEntity<?> getSurveyPerformanceForIntern(@PathVariable Integer internId) {
        ...
        return ResponseEntity.ok(performance); // fixme: remove response entity
    }
    ...
    public ResponseEntity<?> getInternRankingBySurvey(@PathVariable Integer surveyId) {
        ...
        return ResponseEntity.ok(ranking); // fixme: remove response entity
    }
